            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 12,
                  children: [
                    StatCard(label: 'Upcoming', value: '${byBucket[OrderLifecycleBucket.upcoming]}', icon: Icons.hourglass_top_rounded),
                    StatCard(
                        label: 'Running', value: '${byBucket[OrderLifecycleBucket.running]}', icon: Icons.precision_manufacturing_outlined),
                    StatCard(
                        label: 'Completed', value: '${byBucket[OrderLifecycleBucket.completed]}', icon: Icons.check_circle_outline_rounded),
                    StatCard(label: 'Cancelled', value: '${byBucket[OrderLifecycleBucket.cancelled]}', icon: Icons.cancel_outlined),
                  ],
                ),
                const SizedBox(height: 28),
