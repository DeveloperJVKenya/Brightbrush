...
import '../../guide/presentation/guide_editor_screen.dart';
...
/// Support tickets and the Guide's content a real place to be maintained.
final List<RouteBase> adminExtraRoutes = [
  ...
  GoRoute(
    ...
    builder: (context, state) => const GuideEditorScreen(),
  ),
];
