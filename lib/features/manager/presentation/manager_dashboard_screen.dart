                ...
                Wrap(
                  ...
                  children: [
                    ...
                    StatCard(
                      ...
                      hint: 'Orders still in "Pending Review" — confirm or move them into production from Orders.',
                    ),
                    StatCard(
                      label: 'In production',
                      value: '$production',
                      icon: Icons.precision_manufacturing_outlined,
                      hint: 'Orders currently "Confirmed" or "In Production".',
                    ),
                    StatCard(
                      label: 'Ready-for-delivery backlog',
                      value: '$readyBacklog',
                      icon: Icons.inventory_2_outlined,
                      hint: 'Orders ready to go out but not yet assigned to a delivery staff member.',
                    ),
                    StatCard(
                      label: 'Active catalog items',
                      value: '$activeCatalogCount',
                      icon: Icons.checkroom_outlined,
                      hint: 'Catalog items currently visible to customers.',
                    ),
                    StatCard(
                      label: 'Active packages',
                      value: '$activePackagesCount',
                      icon: Icons.card_giftcard_outlined,
                      hint: 'Seasonal packages currently visible to customers.',
                    ),
                  ],
                ),
